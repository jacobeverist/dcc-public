...
var wo;
function wa() {
  return wo || (wo = 1, pn.exports = xa()), pn.exports;
}
var T = wa(), mn = { exports: {} }, G = {};
var vo;
function va() {
  if (vo) return G;
  vo = 1;
  ...
  function N(m, E, L, O, Y) {
    ...
    F = 0;
    var j = O === "" ? "." : O + ":";
    if (C(m)) for (var Z = 0; Z < m.length; Z++) O = m[Z], q = j + v(O, Z), F += N(O, E, L, q, Y);
    else if (Z = h(m), typeof Z == "function") for (m = Z.call(m), Z = 0; !(O = m.next()).done; ) O = O.value, q = j + v(O, Z++), F += N(O, E, L, q, Y);
    else if (q === "object") {
  ...
  return G.Activity = d, G.Children = V, G.Component = y, G.Fragment = n, G.Profiler = r, G.PureComponent = g, G.StrictMode = o, G.Suspense = u, G.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = S, G.__COMPILER_RUNTIME = { __proto__: null, c: function(m) {
    ...
    if (E != null) for (q in E.key !== void 0 && (Y = "" + E.key), E) !R.call(E, q) || q === "key" || q === "__self" || q === "__source" || q === "ref" && E.ref === void 0 || (O[q] = E[q]);
    var q = arguments.length - 2;
    if (q === 1) O.children = L;
    else if (1 < q) {
      for (var F = Array(q), j = 0; j < q; j++) F[j] = arguments[j + 2];
      O.children = F;
    }
    return $(m.type, Y, O);
    ...
    var O, Y = {}, q = null;
    if (E != null) for (O in E.key !== void 0 && (q = "" + E.key), E) R.call(E, O) && O !== "key" && O !== "__self" && O !== "__source" && (Y[O] = E[O]);
...
var _o;
function Qt() {
  return _o || (_o = 1, mn.exports = va()), mn.exports;
}
var H = Qt();
const _a = Tr(H);
var yn = { exports: {} }, ce = {};
...
function ba() {
  ...
  return e3(), yn.exports = Ea(), yn.exports;
}
var Sa = ba();
function se(e3) {
...
function Da(e3) {
  typeof e3 == "function" ? e3 = $a(e3) : e3 = Rr(e3);
...
function La(e3) {
  return this.select(e3 == null ? Oa : za(typeof e3 == "function" ? e3 : Dr(e3)));
}
...
function Fa(e3) {
  return this.selectAll(e3 == null ? Ba : ja(typeof e3 == "function" ? e3 : Dr(e3)));
}
function Ya(e3) {
...
function Ga(e3, t) {
  ...
  var n = t ? Wa : qa, o = this._parents, r = this._groups;
...
function Pc(e3) {
  return arguments.length ? this.each(e3 == null ? Ic : (typeof e3 == "function" ? Tc : kc)(e3)) : this.node().textContent;
}
function Rc() {
  this.innerHTML = "";
}
...
function Fc(e3, t) {
  var n = typeof e3 == "function" ? e3 : Pr(e3), o = t == null ? jc : typeof t == "function" ? t : Xn(t);
  return this.select(function() {
...
fe.prototype = yt.prototype = { constructor: fe, select: Ta, selectAll: Da, selectChild: La, selectChildren: Fa, filter: Ya, data: Ga, enter: Xa, exit: Qa, join: Ja, merge: ec, selection: iu, order: tc, sort: nc, call: rc, nodes: ic, node: sc, size: ac, empty: cc, each: uc, attr: mc, style: vc, property: Sc, classed: Ac, text: Pc, html: Hc, raise: Oc, lower: Vc, append: Bc, insert: Fc, remove: Xc, clone: Wc, datum: Uc, on: eu, dispatch: ou, [Symbol.iterator]: ru };
function le(e3) {
...
}, hex: ko, formatHex: ko, formatHex8: Eu, formatRgb: To, toString: To }));
function ko() {
...
function Cu(e3) {
  return (e3 = +e3) == 1 ? Ur : function(t, n) {
    return n - t ? Nu(t, n, e3) : Wn(isNaN(t) ? n : t);
  };
}
function Ur(e3, t) {
  var n = t - e3;
  return n ? Su(e3, n) : Wn(isNaN(e3) ? t : e3);
}
...
function it(e3, t) {
  var n = typeof t, o;
  return t == null || n === "boolean" ? Wn(t) : (n === "number" ? ye : n === "string" ? (o = De(t)) ? (t = o, Ft) : Gr : t instanceof De ? Ft : t instanceof Date ? ku : Au(t) ? Mu : Array.isArray(t) ? Iu : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? Tu : ye)(e3, t);
}
...
var Hu = Qr($u, "px, ", "px)", "deg)"), zu = Qr(Du, ", ", ")", ")"), Ou = 1e-12;
function Do(e3) {
...
const Ht = (function e2(t, n, o) {
  function r(i, s) {
    ...
    if (p < Ou) y = Math.log(l / a) / t, _ = function(S) {
      ...
      y = (b - C) / t, _ = function(S) {
        var R = S * y, $ = Do(C), X = a / (n * M) * ($ * Vu(t * R + C) - Lu(C));
...
function Hn(e3) {
  if (!Ze) {
    ...
    var t = e3 - He;
    t > 24 ? (e3 < 1 / 0 && (ot = setTimeout(Ho, e3 - lt.now() - tn)), tt && (tt = clearInterval(tt))) : (tt || (Xt = lt.now(), tt = setInterval(Fu, Jr)), Ze = 1, ei(Ho));
  }
}
function zo(e3, t, n) {
  var o = new Zt();
...
var Xu = Jt("start", "end", "cancel", "interrupt"), Zu = [], ni = 0, Oo = 1, zn = 2, zt = 3, Lo = 4, On = 5, Ot = 6;
function nn(e3, t, n, o, r, i) {
  var s = e3.__transition;
  if (!s) e3.__transition = {};
  else if (n in s) return;
  qu(e3, n, { name: t, index: o, group: r, on: Xu, tween: Zu, time: i.time, delay: i.delay, duration: i.duration, ease: i.ease, timer: null, state: ni });
}
function Gn(e3, t) {
  var n = me(e3, t);
...
function rl(e3, t) {
  var n = en(e3), o = n === "transform" ? zu : oi;
...
function Dl(e3, t, n) {
  var o = (e3 += "") == "transform" ? Hu : oi;
  return t == null ? this.styleTween(e3, Tl(e3, o)).on("end.style." + e3, ri(e3)) : typeof t == "function" ? this.styleTween(e3, Rl(e3, o, Kn(this, "style." + e3, t))).each($l(this._id, e3)) : this.styleTween(e3, Pl(e3, o, t), n).on("end.style." + e3, null);
}
function Hl(e3, t, n) {
  return function(o) {
...
var Ee = yt.prototype;
Se.prototype = { constructor: Se, select: Ml, selectAll: Al, selectChild: Ee.selectChild, selectChildren: Ee.selectChildren, filter: vl, merge: _l, selection: kl, transition: Xl, call: Ee.call, nodes: Ee.nodes, node: Ee.node, size: Ee.size, empty: Ee.empty, each: Ee.each, on: Sl, attr: rl, attrTween: ul, style: Dl, styleTween: Ol, text: Bl, textTween: Yl, remove: Cl, tween: Ku, delay: dl, duration: pl, ease: yl, easeVarying: wl, end: Zl, [Symbol.iterator]: Ee[Symbol.iterator] };
function Wl(e3) {
  return ((e3 *= 2) <= 1 ? e3 * e3 * e3 : (e3 -= 2) * e3 * e3 + 2) / 2;
}
var Ul = { time: null, delay: 0, duration: 250, ease: Wl };
function Gl(e3, t) {
...
function Kl(e3) {
  var t, n;
  e3 instanceof Se ? (t = e3._id, e3 = e3._name) : (t = ii(), (n = Ul).time = Un(), e3 = e3 == null ? null : e3 + "");
...
function ai() {
  ...
  function C(v, A, N, I) {
    v.on("start.zoom", function() {
      ...
      var k = this, P = arguments, V = b(k, P).event(I), m = t.apply(k, P), E = N == null ? w(m) : typeof N == "function" ? N.apply(k, P) : N, L = Math.max(m[1][0] - m[0][0], m[1][1] - m[0][1]), O = k.__zoom, Y = typeof A == "function" ? A.apply(k, P) : A, q = u(O.invert(E).concat(L / O.k), Y.invert(E).concat(L / Y.k));
      return function(F) {
        if (F === 1) F = Y;
        else {
          var j = q(F), Z = L / j[2];
  ...
  function $(v, ...A) {
    ...
    function E(O) {
      if (nt(O), !I.moved) {
        var Y = O.clientX - V, q = O.clientY - m;
        I.moved = Y * Y + q * q > p;
      }
  ...
  function z(v, ...A) {
    if (this.__zooming) {
      ...
      if (V = N.that.__zoom, N.touch1) {
        var L = N.touch0[0], O = N.touch0[1], Y = N.touch1[0], q = N.touch1[1], F = (F = Y[0] - L[0]) * F + (F = Y[1] - L[1]) * F, j = (j = q[0] - O[0]) * j + (j = q[1] - O[1]) * j;
        V = M(V, Math.sqrt(F / j)), m = [(L[0] + Y[0]) / 2, (L[1] + Y[1]) / 2], E = [(O[0] + q[0]) / 2, (O[1] + q[1]) / 2];
...
const Bo = { [W.Left]: W.Right, [W.Right]: W.Left, [W.Top]: W.Bottom, [W.Bottom]: W.Top };
function fi(e3) {
  return e3 === null ? null : e3 ? "valid" : "invalid";
}
const di = (e3) => "id" in e3 && "source" in e3 && "target" in e3, rf = (e3) => "id" in e3 && "position" in e3 && !("source" in e3) && !("target" in e3), Qn = (e3) => "id" in e3 && "internals" in e3 && !("source" in e3) && !("target" in e3), wt = (e3, t = [0, 0]) => {
  ...
  const n = e3.reduce((o, r) => {
    ...
    const c = s ? Wt(s, t.nodeOrigin) : { x: 0, y: 0, x2: 0, y2: 0 };
    return rn(o, c);
  ...
  return e3.forEach((r) => {
    (t.filter === void 0 || t.filter(r)) && (n = rn(n, Wt(r)), o = true);
...
const We = (e3, t = 0, n = 1) => Math.min(Math.max(e3, t), n), ze = (e3 = { x: 0, y: 0 }, t, n) => ({ x: We(e3.x, t[0][0], t[1][0] - ((n == null ? void 0 : n.width) ?? 0)), y: We(e3.y, t[0][1], t[1][1] - ((n == null ? void 0 : n.height) ?? 0)) });
function gi(e3, t, n) {
  const { width: o, height: r } = Ne(n), { x: i, y: s } = n.internals.positionAbsolute;
  return ze(e3, [[i, s], [i + o, s + r]], t);
}
const jo = (e3, t, n) => e3 < t ? We(Math.abs(e3 - t), 1, t) / t : e3 > n ? -We(Math.abs(e3 - n), 1, t) / t : 0, pi = (e3, t, n = 15, o = 40) => {
...
}, Fo = (e3) => ge(e3.width) && ge(e3.height) && ge(e3.x) && ge(e3.y), ge = (e3) => !isNaN(e3) && isFinite(e3), ff = (e3, t) => {
...
const eo = (e3, t, n, o, r, i) => {
  const s = df(i, t, n), c = (t - s.x) / e3.width, u = (n - s.y) / e3.height, a = Math.min(c, u), f = We(a, o, r), d = e3.x + e3.width / 2, l = e3.y + e3.height / 2, h = t / 2 - d * f, x = n / 2 - l * f, p = hf(e3, h, x, f, t, n), _ = { left: Math.min(p.left - s.left, 0), top: Math.min(p.top - s.top, 0), right: Math.min(p.right - s.right, 0), bottom: Math.min(p.bottom - s.bottom, 0) };
...
function Ei({ sourceX: e3, sourceY: t, sourcePosition: n = W.Bottom, targetX: o, targetY: r, targetPosition: i = W.Top, curvature: s = 0.25 }) {
...
const wf = ({ source: e3, sourceHandle: t, target: n, targetHandle: o }) => `xy-edge__${e3}${t || ""}-${n}${o || ""}`, vf = (e3, t) => t.some((n) => n.source === e3.source && n.target === e3.target && (n.sourceHandle === e3.sourceHandle || !n.sourceHandle && !e3.sourceHandle) && (n.targetHandle === e3.targetHandle || !n.targetHandle && !e3.targetHandle)), _f = (e3, t) => {
  ...
  let n;
  return di(e3) ? n = { ...e3 } : n = { ...e3, id: wf(e3) }, vf(n, t) ? t : (n.sourceHandle === null && delete n.sourceHandle, n.targetHandle === null && delete n.targetHandle, t.concat(n));
};
...
const qo = { [W.Left]: { x: -1, y: 0 }, [W.Right]: { x: 1, y: 0 }, [W.Top]: { x: 0, y: -1 }, [W.Bottom]: { x: 0, y: 1 } }, Ef = ({ source: e3, sourcePosition: t = W.Bottom, target: n }) => t === W.Left || t === W.Right ? e3.x < n.x ? { x: 1, y: 0 } : { x: -1, y: 0 } : e3.y < n.y ? { x: 0, y: 1 } : { x: 0, y: -1 }, Wo = (e3, t) => Math.sqrt(Math.pow(t.x - e3.x, 2) + Math.pow(t.y - e3.y, 2));
function bf({ source: e3, sourcePosition: t = W.Bottom, target: n, targetPosition: o = W.Top, center: r, offset: i, stepPosition: s }) {
  const c = qo[t], u = qo[o], a = { x: e3.x + c.x * i, y: e3.y + c.y * i }, f = { x: n.x + u.x * i, y: n.y + u.y * i }, d = Ef({ source: a, sourcePosition: t, target: f }), l = d.x !== 0 ? "x" : "y", h = d[l];
  let x = [], p, _;
...
function Vn({ sourceX: e3, sourceY: t, sourcePosition: n = W.Bottom, targetX: o, targetY: r, targetPosition: i = W.Top, borderRadius: s = 5, centerX: c, centerY: u, offset: a = 20, stepPosition: f = 0.5 }) {
...
function Nf(e3) {
  ...
  const o = t.internals.handleBounds || Go(t.handles), r = n.internals.handleBounds || Go(n.handles), i = Ko((o == null ? void 0 : o.source) ?? [], e3.sourceHandle), s = Ko(e3.connectionMode === qe.Strict ? (r == null ? void 0 : r.target) ?? [] : ((r == null ? void 0 : r.target) ?? []).concat((r == null ? void 0 : r.source) ?? []), e3.targetHandle);
  ...
  const c = (i == null ? void 0 : i.position) || W.Bottom, u = (s == null ? void 0 : s.position) || W.Top, a = pt(t, i, c), f = pt(n, s, u);
...
function pt(e3, t, n = W.Left, o = false) {
...
const Ni = 1e3, Mf = 10, oo = { nodeOrigin: [0, 0], nodeExtent: ft, elevateNodesOnSelect: true, defaults: {} }, Af = { ...oo, checkEquality: true };
function ro(e3, t) {
  const n = { ...e3 };
...
function jn(e3, t, n, o) {
  ...
  for (const a of e3) {
    ...
    if (r.checkEquality && a === (f == null ? void 0 : f.internals.userNode)) t.set(a.id, f);
      ...
      f = { ...r.defaults, ...a, measured: { width: (_a2 = a.measured) == null ? void 0 : _a2.width, height: (_b = a.measured) == null ? void 0 : _b.height }, internals: { positionAbsolute: h, handleBounds: kf(a, f), z: Ci(a, u), userNode: a } }, t.set(a.id, f);
    }
...
function io(e3, t, n, o, r) {
  ...
  Tf(e3, n), r && !a.parentId && a.internals.rootParentIndex === void 0 && (a.internals.rootParentIndex = ++r.i, a.internals.z = a.internals.z + r.i * Mf), r && a.internals.rootParentIndex !== void 0 && (r.i = a.internals.rootParentIndex);
...
function zf({ onNodeMouseDown: e3, getStoreItems: t, onDragStart: n, onDrag: o, onDragStop: r }) {
  ...
  function _({ noDragClassName: M, handleSelector: g, domNode: w, isSelectable: C, nodeId: b, nodeClickDistance: S = 0 }) {
    ...
    function R({ x: z, y: B }) {
      ...
      i = { x: z, y: B };
      let L = false;
      const O = c.size > 1, Y = O && A ? Ln(vt(c)) : null, q = O && I ? Hf({ dragItems: c, snapGrid: N, x: z, y: B }) : null;
      for (const [F, j] of c) {
        if (!v.has(F)) continue;
        let Z = { x: z - j.distance.x, y: B - j.distance.y };
        I && (Z = q ? { x: Math.round(Z.x + q.x), y: Math.round(Z.y + q.y) } : _t(Z, N));
        let Q = null;
        if (O && A && !j.extent && Y) {
          const { positionAbsolute: K } = j.internals, te = K.x - Y.x + A[0][0], oe = K.x + j.measured.width - Y.x2 + A[1][0], re = K.y - Y.y + A[0][1], ae = K.y + j.measured.height - Y.y2 + A[1][1];
          Q = [[te, re], [oe, ae]];
        }
...
function jf(e3, { connectionMode: t, connectionRadius: n, handleId: o, nodeId: r, edgeUpdaterType: i, isTarget: s, domNode: c, nodeLookup: u, lib: a, autoPanOnConnect: f, flowId: d, panBy: l, cancelConnection: h, onConnectStart: x, onConnect: p, onConnectEnd: _, isValidConnection: y = Ti, onReconnectEnd: M, updateConnection: g, getTransform: w, getFromHandle: C, autoPanSpeed: b, dragThreshold: S = 1, handleDomNode: R }) {
  ...
  let F = { inProgress: true, isValid: null, from: pt(Y, O, W.Left, true), fromHandle: O, fromPosition: O.position, fromNode: Y, to: k, toHandle: null, toPosition: Bo[O.position], toNode: null };
  function j() {
  ...
  function Z(J) {
    if (!N) {
      const { x: oe, y: re } = pe(J), ae = oe - z, _e = re - B;
    ...
    const U = w();
    k = pe(J, A), D = Vf(Et(k, U, false, [1, 1]), n, u, O), P || (L(), P = true);
...
function Pi(e3, { handle: t, connectionMode: n, fromNodeId: o, fromHandleId: r, fromType: i, doc: s, lib: c, flowId: u, isValidConnection: a = Ti, nodeLookup: f }) {
  ...
  if (_) {
    ...
    y.connection = S;
    const $ = C && b && (n === qe.Strict ? d && M === "source" || !d && M === "target" : g !== o || w !== r);
...
function Wf({ zoomPanValues: e3, panOnDrag: t, onPaneContextMenu: n, onTransformChange: o, onPanZoom: r }) {
  return (i) => {
    var _a2, _b;
...
function Kf({ domNode: e3, minZoom: t, maxZoom: n, translateExtent: o, viewport: r, onPanZoom: i, onPanZoomStart: s, onPanZoomEnd: c, onDraggingChange: u }) {
  ...
  M({ x: r.x, y: r.y, zoom: We(r.zoom, t, n) }, [[0, 0], [f.width, f.height]], o);
  ...
  function _({ noWheelClassName: D, noPanClassName: z, onPaneContextMenu: B, userSelectionActive: v, panOnScroll: A, panOnDrag: N, panOnScrollMode: I, panOnScrollSpeed: k, preventScrolling: P, zoomOnPinch: V, zoomOnScroll: m, zoomOnDoubleClick: E, zoomActivationKeyPressed: L, lib: O, onTransformChange: Y, connectionInProgress: q, paneClickDistance: F, selectionOnDrag: j }) {
    v && !a.isZoomingOrPanning && y();
    const Z = A && !L && !v;
    d.clickDistance(j ? 1 / 0 : !ge(F) || F < 0 ? 0 : F);
    const Q = Z ? Xf({ zoomPanValues: a, noWheelClassName: D, d3Selection: l, d3Zoom: d, panOnScrollMode: I, panOnScrollSpeed: k, zoomOnPinch: V, onPanZoomStart: s, onPanZoom: i, onPanZoomEnd: c }) : Zf({ noWheelClassName: D, preventScrolling: P, d3ZoomHandler: h });
    if (l.on("wheel.zoom", Q, { passive: false }), !v) {
      const U = qf({ zoomPanValues: a, onDraggingChange: u, onPanZoomStart: s });
      d.on("start", U);
      const K = Wf({ zoomPanValues: a, panOnDrag: N, onPaneContextMenu: !!B, onPanZoom: i, onTransformChange: Y });
      d.on("zoom", K);
      const te = Uf({ zoomPanValues: a, panOnDrag: N, panOnScroll: A, onPaneContextMenu: B, onPanZoomEnd: c, onDraggingChange: u });
      d.on("end", te);
    }
    const J = Gf({ zoomActivationKeyPressed: L, panOnDrag: N, zoomOnScroll: m, panOnScroll: A, zoomOnDoubleClick: E, zoomOnPinch: V, userSelectionActive: v, noPanClassName: z, noWheelClassName: D, lib: O, connectionInProgress: q });
...
function id({ domNode: e3, nodeId: t, getStoreItems: n, onChange: o, onEnd: r }) {
  ...
  function c({ controlPosition: a, boundaries: f, keepAspectRatio: d, resizeDirection: l, onResizeStart: h, onResize: x, onResizeEnd: p, shouldResize: _ }) {
    ...
    const X = Zr().on("start", (D) => {
      ...
      y = { width: g.measured.width ?? 0, height: g.measured.height ?? 0, x: g.position.x ?? 0, y: g.position.y ?? 0 }, M = { ...y, pointerX: k, pointerY: P, aspectRatio: y.width / y.height }, b = void 0, g.parentId && (g.extent === "parent" || g.expandParent) && (b = z.get(g.parentId), S = b && g.extent === "parent" ? od(b) : void 0), C = [], R = void 0;
      ...
      if (!g) return;
      const { x: k, y: P, width: V, height: m } = y, E = {}, L = g.origin ?? A, { width: O, height: Y, x: q, y: F } = td(M, s.controlDirection, N, s.boundaries, s.keepAspectRatio, L, S, R), j = O !== V, Z = Y !== m, Q = q !== k && j, J = F !== P && Z;
      if (!Q && !J && !j && !Z) return;
      if ((Q || J || L[0] === 1 || L[1] === 1) && (E.x = Q ? q : y.x, E.y = J ? F : y.y, y.x = E.x, y.y = E.y, C.length > 0)) {
        const oe = q - k, re = F - P;
        for (const ae of C) ae.position = { x: ae.position.x - oe + L[0] * (O - V), y: ae.position.y - re + L[1] * (Y - m) }, I.push(ae);
      }
      if ((j || Z) && (E.width = j && (!s.resizeDirection || s.resizeDirection === "horizontal") ? O : y.width, E.height = Z && (!s.resizeDirection || s.resizeDirection === "vertical") ? Y : y.height, y.width = E.width, y.height = E.height), b && g.expandParent) {
        const oe = L[0] * (E.width ?? 0);
        E.x && E.x < oe && (y.x = oe, M.x = M.x - (E.x - oe));
        const re = L[1] * (E.height ?? 0);
        E.y && E.y < re && (y.y = re, M.y = M.y - (E.y - re));
      }
...
var or;
function ad() {
  return or || (or = 1, Mn.exports = sd()), Mn.exports;
}
var rr;
function cd() {
  if (rr) return Cn;
...
var ir;
function ud() {
  return ir || (ir = 1, Nn.exports = cd()), Nn.exports;
}
var ld = ud();
const fd = Tr(ld), dd = {}, sr = (e3) => {
  let t;
  ...
  return u;
}, hd = (e3) => e3 ? sr(e3) : sr, { useDebugValue: gd } = _a, { useSyncExternalStoreWithSelector: pd } = fd, md = (e3) => e3;
...
const cn = H.createContext(null), xd = cn.Provider, zi = we.error001();
function ee(e3, t) {
...
const cr = { display: "none" }, wd = { position: "absolute", width: 1, height: 1, margin: -1, border: 0, padding: 0, overflow: "hidden", clip: "rect(0px, 0px, 0px, 0px)", clipPath: "inset(100%)" }, Oi = "react-flow__node-desc", Li = "react-flow__edge-desc", vd = "react-flow__aria-live", _d = (e3) => e3.ariaLiveMessage, Ed = (e3) => e3.ariaLabelConfig;
function bd({ rfId: e3 }) {
  const t = ee(_d);
  return T.jsx("div", { id: `${vd}-${e3}`, "aria-live": "assertive", "aria-atomic": "true", style: wd, children: t });
}
function Sd({ rfId: e3, disableKeyboardA11y: t }) {
  const n = ee(Ed);
  return T.jsxs(T.Fragment, { children: [T.jsx("div", { id: `${Oi}-${e3}`, style: cr, children: t ? n["node.a11yDescription.default"] : n["node.a11yDescription.keyboardDisabled"] }), T.jsx("div", { id: `${Li}-${e3}`, style: cr, children: n["edge.a11yDescription.default"] }), !t && T.jsx(bd, { rfId: e3 })] });
}
...
function Ad({ onSelectionChange: e3 }) {
  const t = ne(), { selectedNodes: n, selectedEdges: o } = ee(Cd, Md);
  return H.useEffect(() => {
...
function kd({ onSelectionChange: e3 }) {
  const t = ee(Id);
  return e3 || t ? T.jsx(Ad, { onSelectionChange: e3 }) : null;
}
const Vi = [0, 0], Td = { x: 0, y: 0, zoom: 1 }, Pd = ["nodes", "edges", "defaultNodes", "defaultEdges", "onConnect", "onConnectStart", "onConnectEnd", "onClickConnectStart", "onClickConnectEnd", "nodesDraggable", "autoPanOnNodeFocus", "nodesConnectable", "nodesFocusable", "edgesFocusable", "edgesReconnectable", "elevateNodesOnSelect", "elevateEdgesOnSelect", "minZoom", "maxZoom", "nodeExtent", "onNodesChange", "onEdgesChange", "elementsSelectable", "connectionMode", "snapGrid", "snapToGrid", "translateExtent", "connectOnClick", "defaultEdgeOptions", "fitView", "fitViewOptions", "onNodesDelete", "onEdgesDelete", "onDelete", "onNodeDrag", "onNodeDragStart", "onNodeDragStop", "onSelectionDrag", "onSelectionDragStart", "onSelectionDragStop", "onMoveStart", "onMove", "onMoveEnd", "noPanClassName", "nodeOrigin", "autoPanOnConnect", "autoPanOnNodeDrag", "onError", "connectionRadius", "isValidConnection", "selectNodesOnDrag", "nodeDragThreshold", "connectionDragThreshold", "onBeforeDelete", "debug", "autoPanSpeed", "ariaLabelConfig"], ur = [...Pd, "rfId"], Rd = (e3) => ({ setNodes: e3.setNodes, setEdges: e3.setEdges, setMinZoom: e3.setMinZoom, setMaxZoom: e3.setMaxZoom, setTranslateExtent: e3.setTranslateExtent, setNodeExtent: e3.setNodeExtent, reset: e3.reset, setDefaultNodesAndEdges: e3.setDefaultNodesAndEdges }), lr = { translateExtent: ft, nodeOrigin: Vi, minZoom: 0.5, maxZoom: 2, elementsSelectable: true, noPanClassName: "nopan", rfId: "1" };
function $d(e3) {
  const { setNodes: t, setEdges: n, setMinZoom: o, setMaxZoom: r, setTranslateExtent: i, setNodeExtent: s, reset: c, setDefaultNodesAndEdges: u } = ee(Rd, ie), a = ne();
...
const yr = (e3) => rf(e3), Vd = (e3) => di(e3);
function ji(e3) {
  return H.forwardRef(e3);
}
const Bd = typeof window < "u" ? H.useLayoutEffect : H.useEffect;
function xr(e3) {
  const [t, n] = H.useState(BigInt(0)), [o] = H.useState(() => jd(() => n((r) => r + BigInt(1))));
  return Bd(() => {
    const r = o.get();
...
const Fi = H.createContext(null);
function Fd({ children: e3 }) {
  const t = ne(), n = H.useCallback((c) => {
  ...
  return T.jsx(Fi.Provider, { value: s, children: e3 });
}
function Yd() {
  const e3 = H.useContext(Fi);
  if (!e3) throw new Error("useBatchContext must be used within a BatchProvider");
  return e3;
}
const Xd = (e3) => !!e3.panZoom;
function ao() {
  const e3 = Hd(), t = ne(), n = Yd(), o = ee(Xd), r = H.useMemo(() => {
...
const wr = (e3) => e3.selected, Zd = typeof window < "u" ? window : void 0;
function qd({ deleteKeyCode: e3, multiSelectionKeyCode: t }) {
  const n = ne(), { deleteElements: o } = ao(), r = mt(e3, { actInsideInputWithModifier: false }), i = mt(t, { target: Zd });
  H.useEffect(() => {
    if (r) {
...
const ln = { position: "absolute", width: "100%", height: "100%", top: 0, left: 0 }, Ud = (e3) => ({ userSelectionActive: e3.userSelectionActive, lib: e3.lib, connectionInProgress: e3.connection.inProgress });
function Gd({ onPaneContextMenu: e3, zoomOnScroll: t = true, zoomOnPinch: n = true, panOnScroll: o = false, panOnScrollSpeed: r = 0.5, panOnScrollMode: i = $e.Free, zoomOnDoubleClick: s = true, panOnDrag: c = true, defaultViewport: u, translateExtent: a, minZoom: f, maxZoom: d, zoomActivationKeyCode: l, preventScrolling: h = true, children: x, noWheelClassName: p, noPanClassName: _, onViewportChange: y, isControlledViewport: M, paneClickDistance: g, selectionOnDrag: w }) {
  const C = ne(), b = H.useRef(null), { userSelectionActive: S, lib: R, connectionInProgress: $ } = ee(Ud, ie), X = mt(l), D = H.useRef();
  Wd(b);
...
const Kd = (e3) => ({ userSelectionActive: e3.userSelectionActive, userSelectionRect: e3.userSelectionRect });
function Qd() {
  const { userSelectionActive: e3, userSelectionRect: t } = ee(Kd, ie);
...
}, Jd = (e3) => ({ userSelectionActive: e3.userSelectionActive, elementsSelectable: e3.elementsSelectable, connectionInProgress: e3.connection.inProgress, dragging: e3.paneDragging });
function eh({ isSelecting: e3, selectionKeyPressed: t, selectionMode: n = dt.Full, panOnDrag: o, paneClickDistance: r, selectionOnDrag: i, onSelectionStart: s, onSelectionEnd: c, onPaneClick: u, onPaneContextMenu: a, onPaneScroll: f, onPaneMouseEnter: d, onPaneMouseMove: l, onPaneMouseLeave: h, children: x }) {
  const p = ne(), { userSelectionActive: _, elementsSelectable: y, dragging: M, connectionInProgress: g } = ee(Jd, ie), w = y && (e3 || _), C = H.useRef(null), b = H.useRef(), S = H.useRef(/* @__PURE__ */ new Set()), R = H.useRef(/* @__PURE__ */ new Set()), $ = H.useRef(false), X = (k) => {
    if ($.current || g) {
      $.current = false;
      return;
    }
    ...
    const { userSelectionRect: P, transform: V, nodeLookup: m, edgeLookup: E, connectionLookup: L, triggerNodeChanges: O, triggerEdgeChanges: Y, defaultEdgeOptions: q, resetSelectedElements: F } = p.getState();
    if (!b.current || !P) return;
    const { x: j, y: Z } = pe(k.nativeEvent, b.current), { startX: Q, startY: J } = P;
    if (!$.current) {
      const re = t ? 0 : r;
      if (Math.hypot(j - Q, Z - J) <= re) return;
      F(), s == null ? void 0 : s(k);
    }
    $.current = true;
    const U = { startX: Q, startY: J, x: j < Q ? j : Q, y: Z < J ? Z : J, width: Math.abs(j - Q), height: Math.abs(Z - J) }, K = S.current, te = R.current;
    S.current = new Set(Jn(m, U, V, n === dt.Partial, true).map((re) => re.id)), R.current = /* @__PURE__ */ new Set();
    const oe = (q == null ? void 0 : q.selectable) ?? true;
    for (const re of S.current) {
      const ae = L.get(re);
      if (ae) for (const { edgeId: _e } of ae.values()) {
        const ke = E.get(_e);
        ke && (ke.selectable ?? oe) && R.current.add(_e);
      }
    }
    if (!Yo(K, S.current)) {
      const re = je(m, S.current, true);
      O(re);
    }
    if (!Yo(te, R.current)) {
      const re = je(E, R.current);
      Y(re);
    }
  ...
  return T.jsxs("div", { className: se(["react-flow__pane", { draggable: I, dragging: M, selection: e3 }]), onClick: w ? void 0 : In(X, C), onContextMenu: In(D, C), onWheel: In(z, C), onPointerEnter: w ? void 0 : d, onPointerMove: w ? A : l, onPointerUp: w ? N : void 0, onPointerDownCapture: w ? v : void 0, onClickCapture: w ? B : void 0, onPointerLeave: h, ref: C, style: ln, children: [x, T.jsx(Qd, {})] });
}
...
function Yi({ nodeRef: e3, disabled: t = false, noDragClassName: n, handleSelector: o, nodeId: r, isSelectable: i, nodeClickDistance: s }) {
  const c = ne(), [u, a] = H.useState(false), f = H.useRef();
  return H.useEffect(() => {
    f.current = zf({ getStoreItems: () => c.getState(), onNodeMouseDown: (d) => {
...
const th = (e3) => (t) => t.selected && (t.draggable || e3 && typeof t.draggable > "u");
function Xi() {
  const e3 = ne();
  return H.useCallback((n) => {
    const { nodeExtent: o, snapToGrid: r, snapGrid: i, nodesDraggable: s, onError: c, updateNodePositions: u, nodeLookup: a, nodeOrigin: f } = e3.getState(), d = /* @__PURE__ */ new Map(), l = th(s), h = r ? i[0] : 5, x = r ? i[1] : 5, p = n.direction.x * h * n.factor, _ = n.direction.y * x * n.factor;
    for (const [, y] of a) {
      if (!l(y)) continue;
...
const co = H.createContext(null), nh = co.Provider;
co.Consumer;
const Zi = () => H.useContext(co), oh = (e3) => ({ connectOnClick: e3.connectOnClick, noPanClassName: e3.noPanClassName, rfId: e3.rfId }), rh = (e3, t, n) => (o) => {
  ...
  return { connectingFrom: (c == null ? void 0 : c.nodeId) === e3 && (c == null ? void 0 : c.id) === t && (c == null ? void 0 : c.type) === n, connectingTo: f, clickConnecting: (r == null ? void 0 : r.nodeId) === e3 && (r == null ? void 0 : r.id) === t && (r == null ? void 0 : r.type) === n, isPossibleEndHandle: i === qe.Strict ? (c == null ? void 0 : c.type) !== n : e3 !== (c == null ? void 0 : c.nodeId) || t !== (c == null ? void 0 : c.id), connectionInProcess: !!c, clickConnectionInProcess: !!r, valid: f && a };
};
function ih({ type: e3 = "source", position: t = W.Top, isValidConnection: n, isConnectable: o = true, isConnectableStart: r = true, isConnectableEnd: i = true, id: s, onConnect: c, children: u, className: a, onMouseDown: f, onTouchStart: d, ...l }, h) {
  var _a2, _b;
  const x = s || null, p = e3 === "target", _ = ne(), y = Zi(), { connectOnClick: M, noPanClassName: g, rfId: w } = ee(oh, ie), { connectingFrom: C, connectingTo: b, clickConnecting: S, isPossibleEndHandle: R, connectionInProcess: $, clickConnectionInProcess: X, valid: D } = ee(rh(y, x, e3), ie);
  ...
  const z = (A) => {
    ...
    const Y = xi(A.target), q = n || V, { connection: F, isValid: j } = Fn.isValid(A.nativeEvent, { handle: { nodeId: y, id: x, type: e3 }, connectionMode: P, fromNodeId: k.nodeId, fromHandleId: k.id || null, fromType: k.type, isValidConnection: q, flowId: E, doc: Y, lib: m, nodeLookup: L });
    j && F && z(F);
...
const Gt = H.memo(ji(ih));
function sh({ data: e3, isConnectable: t, sourcePosition: n = W.Bottom }) {
  return T.jsxs(T.Fragment, { children: [e3 == null ? void 0 : e3.label, T.jsx(Gt, { type: "source", position: n, isConnectable: t })] });
}
function ah({ data: e3, isConnectable: t, targetPosition: n = W.Top, sourcePosition: o = W.Bottom }) {
...
function uh({ data: e3, isConnectable: t, targetPosition: n = W.Top }) {
  return T.jsxs(T.Fragment, { children: [T.jsx(Gt, { type: "target", position: n, isConnectable: t }), e3 == null ? void 0 : e3.label] });
}
const Kt = { ArrowUp: { x: 0, y: -1 }, ArrowDown: { x: 0, y: 1 }, ArrowLeft: { x: -1, y: 0 }, ArrowRight: { x: 1, y: 0 } }, vr = { input: sh, default: ah, output: uh, group: ch };
function lh(e3) {
  var _a2, _b, _c2, _d2;
...
function dh({ onSelectionContextMenu: e3, noPanClassName: t, disableKeyboardA11y: n }) {
  const o = ne(), { width: r, height: i, transformString: s, userSelectionActive: c } = ee(fh, ie), u = Xi(), a = H.useRef(null);
  if (H.useEffect(() => {
    var _a2;
    n || ((_a2 = a.current) == null ? void 0 : _a2.focus({ preventScroll: true }));
  }, [n]), Yi({ nodeRef: a }), c || !r || !i) return null;
  const f = e3 ? (l) => {
...
const _r = typeof window < "u" ? window : void 0, hh = (e3) => ({ nodesSelectionActive: e3.nodesSelectionActive, userSelectionActive: e3.userSelectionActive });
function qi({ children: e3, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: o, onPaneMouseLeave: r, onPaneContextMenu: i, onPaneScroll: s, paneClickDistance: c, deleteKeyCode: u, selectionKeyCode: a, selectionOnDrag: f, selectionMode: d, onSelectionStart: l, onSelectionEnd: h, multiSelectionKeyCode: x, panActivationKeyCode: p, zoomActivationKeyCode: _, elementsSelectable: y, zoomOnScroll: M, zoomOnPinch: g, panOnScroll: w, panOnScrollSpeed: C, panOnScrollMode: b, zoomOnDoubleClick: S, panOnDrag: R, defaultViewport: $, translateExtent: X, minZoom: D, maxZoom: z, preventScrolling: B, onSelectionContextMenu: v, noWheelClassName: A, noPanClassName: N, disableKeyboardA11y: I, onViewportChange: k, isControlledViewport: P }) {
  const { nodesSelectionActive: V, userSelectionActive: m } = ee(hh), E = mt(a, { target: _r }), L = mt(p, { target: _r }), O = L || R, Y = L || w, q = f && O !== true, F = E || m || q;
  return qd({ deleteKeyCode: u, multiSelectionKeyCode: x }), T.jsx(Gd, { onPaneContextMenu: i, elementsSelectable: y, zoomOnScroll: M, zoomOnPinch: g, panOnScroll: Y, panOnScrollSpeed: C, panOnScrollMode: b, zoomOnDoubleClick: S, panOnDrag: !E && O, defaultViewport: $, translateExtent: X, minZoom: D, maxZoom: z, zoomActivationKeyCode: _, preventScrolling: B, noWheelClassName: A, noPanClassName: N, onViewportChange: k, isControlledViewport: P, paneClickDistance: c, selectionOnDrag: q, children: T.jsxs(eh, { onSelectionStart: l, onSelectionEnd: h, onPaneClick: t, onPaneMouseEnter: n, onPaneMouseMove: o, onPaneMouseLeave: r, onPaneContextMenu: i, onPaneScroll: s, panOnDrag: O, isSelecting: !!F, selectionMode: d, selectionKeyPressed: E, paneClickDistance: c, selectionOnDrag: q, children: [e3, V && T.jsx(dh, { onSelectionContextMenu: v, noPanClassName: N, disableKeyboardA11y: I })] }) });
}
qi.displayName = "FlowRenderer";
const gh = H.memo(qi), ph = (e3) => (t) => e3 ? Jn(t.nodeLookup, { x: 0, y: 0, width: t.width, height: t.height }, t.transform, true).map((n) => n.id) : Array.from(t.nodeLookup.keys());
function mh(e3) {
  return ee(H.useCallback(ph(e3), [e3]), ie);
}
const yh = (e3) => e3.updateNodeInternals;
function xh() {
  const e3 = ee(yh), [t] = H.useState(() => typeof ResizeObserver > "u" ? null : new ResizeObserver((n) => {
...
function wh({ node: e3, nodeType: t, hasDimensions: n, resizeObserver: o }) {
  const r = ne(), i = H.useRef(null), s = H.useRef(null), c = H.useRef(e3.sourcePosition), u = H.useRef(e3.targetPosition), a = H.useRef(t), f = n && !!e3.internals.handleBounds;
  return H.useEffect(() => {
...
function vh({ id: e3, onClick: t, onMouseEnter: n, onMouseMove: o, onMouseLeave: r, onContextMenu: i, onDoubleClick: s, nodesDraggable: c, elementsSelectable: u, nodesConnectable: a, nodesFocusable: f, resizeObserver: d, noDragClassName: l, noPanClassName: h, disableKeyboardA11y: x, rfId: p, nodeTypes: _, nodeClickDistance: y, onError: M }) {
  ...
  const R = !!(g.draggable || c && typeof g.draggable > "u"), $ = !!(g.selectable || u && typeof g.selectable > "u"), X = !!(g.connectable || a && typeof g.connectable > "u"), D = !!(g.focusable || f && typeof g.focusable > "u"), z = ne(), B = to(g), v = wh({ node: g, nodeType: b, hasDimensions: B, resizeObserver: d }), A = Yi({ nodeRef: v, disabled: g.hidden || !R, noDragClassName: l, handleSelector: g.dragHandle, nodeId: e3, isSelectable: $, nodeClickDistance: y }), N = Xi();
  if (g.hidden) return null;
  const I = Ne(g), k = lh(g), P = $ || R || t || n || o || r, V = n ? (j) => n(j, { ...w.userNode }) : void 0, m = o ? (j) => o(j, { ...w.userNode }) : void 0, E = r ? (j) => r(j, { ...w.userNode }) : void 0, L = i ? (j) => i(j, { ...w.userNode }) : void 0, O = s ? (j) => s(j, { ...w.userNode }) : void 0, Y = (j) => {
  ...
  return T.jsx("div", { className: se(["react-flow__node", `react-flow__node-${b}`, { [h]: R }, g.className, { selected: g.selected, selectable: $, parent: C, draggable: R, dragging: A }]), ref: v, style: { zIndex: w.z, transform: `translate(${w.positionAbsolute.x}px,${w.positionAbsolute.y}px)`, pointerEvents: P ? "all" : "none", visibility: B ? "visible" : "hidden", ...g.style, ...k }, "data-id": e3, "data-testid": `rf__node-${e3}`, onMouseEnter: V, onMouseMove: m, onMouseLeave: E, onContextMenu: L, onClick: Y, onDoubleClick: O, onKeyDown: D ? q : void 0, tabIndex: D ? 0 : void 0, onFocus: D ? F : void 0, role: g.ariaRole ?? (D ? "group" : void 0), "aria-roledescription": "node", "aria-describedby": x ? void 0 : `${Oi}-${p}`, "aria-label": g.ariaLabel, ...g.domAttributes, children: T.jsx(nh, { value: e3, children: T.jsx(S, { id: e3, data: g.data, type: b, positionAbsoluteX: w.positionAbsolute.x, positionAbsoluteY: w.positionAbsolute.y, selected: g.selected ?? false, selectable: $, draggable: R, deletable: g.deletable ?? true, isConnectable: X, sourcePosition: g.sourcePosition, targetPosition: g.targetPosition, dragging: A, dragHandle: g.dragHandle, zIndex: w.z, parentId: g.parentId, ...I }) }) });
}
var _h = H.memo(vh);
const Eh = (e3) => ({ nodesDraggable: e3.nodesDraggable, nodesConnectable: e3.nodesConnectable, nodesFocusable: e3.nodesFocusable, elementsSelectable: e3.elementsSelectable, onError: e3.onError });
function Wi(e3) {
  const { nodesDraggable: t, nodesConnectable: n, nodesFocusable: o, elementsSelectable: r, onError: i } = ee(Eh, ie), s = mh(e3.onlyRenderVisibleElements), c = xh();
  return T.jsx("div", { className: "react-flow__nodes", style: ln, children: s.map((u) => T.jsx(_h, { id: u, nodeTypes: e3.nodeTypes, nodeExtent: e3.nodeExtent, onClick: e3.onNodeClick, onMouseEnter: e3.onNodeMouseEnter, onMouseMove: e3.onNodeMouseMove, onMouseLeave: e3.onNodeMouseLeave, onContextMenu: e3.onNodeContextMenu, onDoubleClick: e3.onNodeDoubleClick, noDragClassName: e3.noDragClassName, noPanClassName: e3.noPanClassName, rfId: e3.rfId, disableKeyboardA11y: e3.disableKeyboardA11y, resizeObserver: c, nodesDraggable: t, nodesConnectable: n, nodesFocusable: o, elementsSelectable: r, nodeClickDistance: e3.nodeClickDistance, onError: i }, u)) });
}
Wi.displayName = "NodeRenderer";
const bh = H.memo(Wi);
function Sh(e3) {
...
const Nh = ({ color: e3 = "none", strokeWidth: t = 1 }) => {
...
}, Ch = ({ color: e3 = "none", strokeWidth: t = 1 }) => {
...
}, Er = { [qt.Arrow]: Nh, [qt.ArrowClosed]: Ch };
function Mh(e3) {
  const t = ne();
  return H.useMemo(() => {
    var _a2, _b;
...
const Ah = ({ id: e3, type: t, color: n, width: o = 12.5, height: r = 12.5, markerUnits: i = "strokeWidth", strokeWidth: s, orient: c = "auto-start-reverse" }) => {
  const u = Mh(t);
...
}, Ui = ({ defaultColor: e3, rfId: t }) => {
  const n = ee((i) => i.edges), o = ee((i) => i.defaultEdgeOptions), r = H.useMemo(() => Cf(n, { id: t, defaultColor: e3, defaultMarkerStart: o == null ? void 0 : o.markerStart, defaultMarkerEnd: o == null ? void 0 : o.markerEnd }), [n, o, t, e3]);
  return r.length ? T.jsx("svg", { className: "react-flow__marker", "aria-hidden": "true", children: T.jsx("defs", { children: r.map((i) => T.jsx(Ah, { id: i.id, type: i.type, color: i.color, width: i.width, height: i.height, markerUnits: i.markerUnits, strokeWidth: i.strokeWidth, orient: i.orient }, i.id)) }) }) : null;
};
Ui.displayName = "MarkerDefinitions";
var Ih = H.memo(Ui);
function Gi({ x: e3, y: t, label: n, labelStyle: o, labelShowBg: r = true, labelBgStyle: i, labelBgPadding: s = [2, 4], labelBgBorderRadius: c = 2, children: u, className: a, ...f }) {
...
function Qi(e3) {
  return H.memo(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: i, sourcePosition: s, targetPosition: c, label: u, labelStyle: a, labelShowBg: f, labelBgStyle: d, labelBgPadding: l, labelBgBorderRadius: h, style: x, markerEnd: p, markerStart: _, interactionWidth: y }) => {
    const [M, g, w] = Ki({ sourceX: n, sourceY: o, sourcePosition: s, targetX: r, targetY: i, targetPosition: c }), C = e3.isInternal ? void 0 : t;
...
const Th = Qi({ isInternal: false }), Ji = Qi({ isInternal: true });
Th.displayName = "SimpleBezierEdge";
Ji.displayName = "SimpleBezierEdgeInternal";
function es(e3) {
  return H.memo(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: i, label: s, labelStyle: c, labelShowBg: u, labelBgStyle: a, labelBgPadding: f, labelBgBorderRadius: d, style: l, sourcePosition: h = W.Bottom, targetPosition: x = W.Top, markerEnd: p, markerStart: _, pathOptions: y, interactionWidth: M }) => {
...
const ts = es({ isInternal: false }), ns = es({ isInternal: true });
ts.displayName = "SmoothStepEdge";
ns.displayName = "SmoothStepEdgeInternal";
function os(e3) {
  return H.memo(({ id: t, ...n }) => {
    var _a2;
    const o = e3.isInternal ? void 0 : t;
    return T.jsx(ts, { ...n, id: o, pathOptions: H.useMemo(() => {
      var _a3;
      return { borderRadius: 0, offset: (_a3 = n.pathOptions) == null ? void 0 : _a3.offset };
    }, [(_a2 = n.pathOptions) == null ? void 0 : _a2.offset]) });
  });
}
const Ph = os({ isInternal: false }), rs = os({ isInternal: true });
...
const Rh = is({ isInternal: false }), ss = is({ isInternal: true });
Rh.displayName = "StraightEdge";
ss.displayName = "StraightEdgeInternal";
function as(e3) {
  return H.memo(({ id: t, sourceX: n, sourceY: o, targetX: r, targetY: i, sourcePosition: s = W.Bottom, targetPosition: c = W.Top, label: u, labelStyle: a, labelShowBg: f, labelBgStyle: d, labelBgPadding: l, labelBgBorderRadius: h, style: x, markerEnd: p, markerStart: _, pathOptions: y, interactionWidth: M }) => {
...
const $h = as({ isInternal: false }), cs = as({ isInternal: true });
$h.displayName = "BezierEdge";
cs.displayName = "BezierEdgeInternal";
const Sr = { default: cs, straight: ss, step: rs, smoothstep: ns, simplebezier: Ji }, Nr = { sourceX: null, sourceY: null, targetX: null, targetY: null, sourcePosition: null, targetPosition: null }, Dh = (e3, t, n) => n === W.Left ? e3 - t : n === W.Right ? e3 + t : e3, Hh = (e3, t, n) => n === W.Top ? e3 - t : n === W.Bottom ? e3 + t : e3, Cr = "react-flow__edgeupdater";
function Mr({ position: e3, centerX: t, centerY: n, radius: o = 10, onMouseDown: r, onMouseEnter: i, onMouseOut: s, type: c }) {
  return T.jsx("circle", { onMouseDown: r, onMouseEnter: i, onMouseOut: s, className: se([Cr, `${Cr}-${c}`]), cx: Dh(t, o, e3), cy: Hh(n, o, e3), r: o, stroke: "transparent", fill: "transparent" });
}
function zh({ isReconnectable: e3, reconnectRadius: t, edge: n, sourceX: o, sourceY: r, targetX: i, targetY: s, sourcePosition: c, targetPosition: u, onReconnect: a, onReconnectStart: f, onReconnectEnd: d, setReconnecting: l, setUpdateHover: h }) {
  const x = ne(), p = (w, C) => {
...
function Oh({ id: e3, edgesFocusable: t, edgesReconnectable: n, elementsSelectable: o, onClick: r, onDoubleClick: i, onContextMenu: s, onMouseEnter: c, onMouseMove: u, onMouseLeave: a, reconnectRadius: f, onReconnect: d, onReconnectStart: l, onReconnectEnd: h, rfId: x, edgeTypes: p, noPanClassName: _, onError: y, disableKeyboardA11y: M }) {
  ...
  const S = !!(g.focusable || t && typeof g.focusable > "u"), R = typeof d < "u" && (g.reconnectable || n && typeof g.reconnectable > "u"), $ = !!(g.selectable || o && typeof g.selectable > "u"), X = H.useRef(null), [D, z] = H.useState(false), [B, v] = H.useState(false), A = ne(), { zIndex: N, sourceX: I, sourceY: k, targetX: P, targetY: V, sourcePosition: m, targetPosition: E } = ee(H.useCallback((U) => {
    const K = U.nodeLookup.get(g.source), te = U.nodeLookup.get(g.target);
    if (!K || !te) return { zIndex: g.zIndex, ...Nr };
    const oe = Nf({ id: e3, sourceNode: K, targetNode: te, sourceHandle: g.sourceHandle || null, targetHandle: g.targetHandle || null, connectionMode: U.connectionMode, onError: y });
    return { zIndex: yf({ selected: g.selected, zIndex: g.zIndex, sourceNode: K, targetNode: te, elevateOnSelect: U.elevateEdgesOnSelect }), ...oe || Nr };
  }, [g.source, g.target, g.sourceHandle, g.targetHandle, g.selected, g.zIndex]), ie), L = H.useMemo(() => g.markerStart ? `url('#${Bn(g.markerStart, x)}')` : void 0, [g.markerStart, x]), O = H.useMemo(() => g.markerEnd ? `url('#${Bn(g.markerEnd, x)}')` : void 0, [g.markerEnd, x]);
  if (g.hidden || I === null || k === null || P === null || V === null) return null;
  const Y = (U) => {
    var _a2;
    const { addSelectedEdges: K, unselectNodesAndEdges: te, multiSelectionActive: oe } = A.getState();
    $ && (A.setState({ nodesSelectionActive: false }), g.selected && oe ? (te({ nodes: [], edges: [g] }), (_a2 = X.current) == null ? void 0 : _a2.blur()) : K([e3])), r && r(U, g);
  }, q = i ? (U) => {
    i(U, { ...g });
  } : void 0, F = s ? (U) => {
    s(U, { ...g });
...
const Gh = (e3) => ({ nodesConnectable: e3.nodesConnectable, isValid: e3.connection.isValid, inProgress: e3.connection.inProgress, width: e3.width, height: e3.height });
function Kh({ containerStyle: e3, style: t, type: n, component: o }) {
  const { nodesConnectable: r, width: i, height: s, isValid: c, inProgress: u } = ee(Gh, ie);
  return !(i && r && u) ? null : T.jsx("svg", { style: e3, width: i, height: s, className: "react-flow__connectionline react-flow__container", children: T.jsx("g", { className: se(["react-flow__connection", fi(c)]), children: T.jsx(ls, { style: t, type: n, CustomComponent: o, isValid: c }) }) });
}
const ls = ({ style: e3, type: t = Ae.Bezier, CustomComponent: n, isValid: o }) => {
  const { inProgress: r, from: i, fromNode: s, fromHandle: c, fromPosition: u, to: a, toNode: f, toHandle: d, toPosition: l } = Uh();
  if (!r) return;
...
const Qh = {};
function Ar(e3 = Qh) {
  H.useRef(e3), ne(), H.useEffect(() => {
  }, [e3]);
}
function Jh() {
  ne(), H.useRef(false), H.useEffect(() => {
  }, []);
}
function fs({ nodeTypes: e3, edgeTypes: t, onInit: n, onNodeClick: o, onEdgeClick: r, onNodeDoubleClick: i, onEdgeDoubleClick: s, onNodeMouseEnter: c, onNodeMouseMove: u, onNodeMouseLeave: a, onNodeContextMenu: f, onSelectionContextMenu: d, onSelectionStart: l, onSelectionEnd: h, connectionLineType: x, connectionLineStyle: p, connectionLineComponent: _, connectionLineContainerStyle: y, selectionKeyCode: M, selectionOnDrag: g, selectionMode: w, multiSelectionKeyCode: C, panActivationKeyCode: b, zoomActivationKeyCode: S, deleteKeyCode: R, onlyRenderVisibleElements: $, elementsSelectable: X, defaultViewport: D, translateExtent: z, minZoom: B, maxZoom: v, preventScrolling: A, defaultMarkerColor: N, zoomOnScroll: I, zoomOnPinch: k, panOnScroll: P, panOnScrollSpeed: V, panOnScrollMode: m, zoomOnDoubleClick: E, panOnDrag: L, onPaneClick: O, onPaneMouseEnter: Y, onPaneMouseMove: q, onPaneMouseLeave: F, onPaneScroll: j, onPaneContextMenu: Z, paneClickDistance: Q, nodeClickDistance: J, onEdgeContextMenu: U, onEdgeMouseEnter: K, onEdgeMouseMove: te, onEdgeMouseLeave: oe, reconnectRadius: re, onReconnect: ae, onReconnectStart: _e, onReconnectEnd: ke, noDragClassName: bt, noWheelClassName: St, noPanClassName: Ke, disableKeyboardA11y: Qe, nodeExtent: dn, rfId: Nt, viewport: Le, onViewportChange: Je }) {
  return Ar(e3), Ar(t), Jh(), Yh(n), Zh(Le), T.jsx(gh, { onPaneClick: O, onPaneMouseEnter: Y, onPaneMouseMove: q, onPaneMouseLeave: F, onPaneContextMenu: Z, onPaneScroll: j, paneClickDistance: Q, deleteKeyCode: R, selectionKeyCode: M, selectionOnDrag: g, selectionMode: w, onSelectionStart: l, onSelectionEnd: h, multiSelectionKeyCode: C, panActivationKeyCode: b, zoomActivationKeyCode: S, elementsSelectable: X, zoomOnScroll: I, zoomOnPinch: k, zoomOnDoubleClick: E, panOnScroll: P, panOnScrollSpeed: V, panOnScrollMode: m, panOnDrag: L, defaultViewport: D, translateExtent: z, minZoom: B, maxZoom: v, onSelectionContextMenu: d, preventScrolling: A, noDragClassName: bt, noWheelClassName: St, noPanClassName: Ke, disableKeyboardA11y: Qe, onViewportChange: Je, isControlledViewport: !!Le, children: T.jsxs(Fh, { children: [T.jsx(Bh, { edgeTypes: t, onEdgeClick: r, onEdgeDoubleClick: s, onReconnect: ae, onReconnectStart: _e, onReconnectEnd: ke, onlyRenderVisibleElements: $, onEdgeContextMenu: U, onEdgeMouseEnter: K, onEdgeMouseMove: te, onEdgeMouseLeave: oe, reconnectRadius: re, defaultMarkerColor: N, noPanClassName: Ke, disableKeyboardA11y: Qe, rfId: Nt }), T.jsx(Kh, { style: p, type: x, component: _, containerStyle: y }), T.jsx("div", { className: "react-flow__edgelabel-renderer" }), T.jsx(bh, { nodeTypes: e3, onNodeClick: o, onNodeDoubleClick: i, onNodeMouseEnter: c, onNodeMouseMove: u, onNodeMouseLeave: a, onNodeContextMenu: f, nodeClickDistance: J, onlyRenderVisibleElements: $, noPanClassName: Ke, noDragClassName: bt, disableKeyboardA11y: Qe, nodeExtent: dn, rfId: Nt }), T.jsx("div", { className: "react-flow__viewport-portal" })] }) });
}
fs.displayName = "GraphView";
const eg = H.memo(fs), Ir = ({ nodes: e3, edges: t, defaultNodes: n, defaultEdges: o, width: r, height: i, fitView: s, fitViewOptions: c, minZoom: u = 0.5, maxZoom: a = 2, nodeOrigin: f, nodeExtent: d } = {}) => {
...
function ng({ initialNodes: e3, initialEdges: t, defaultNodes: n, defaultEdges: o, initialWidth: r, initialHeight: i, initialMinZoom: s, initialMaxZoom: c, initialFitViewOptions: u, fitView: a, nodeOrigin: f, nodeExtent: d, children: l }) {
  const [h] = H.useState(() => tg({ nodes: e3, edges: t, defaultNodes: n, defaultEdges: o, width: r, height: i, fitView: a, minZoom: s, maxZoom: c, fitViewOptions: u, nodeOrigin: f, nodeExtent: d }));
  return T.jsx(xd, { value: h, children: T.jsx(Fd, { children: l }) });
}
function og({ children: e3, nodes: t, edges: n, defaultNodes: o, defaultEdges: r, width: i, height: s, fitView: c, fitViewOptions: u, minZoom: a, maxZoom: f, nodeOrigin: d, nodeExtent: l }) {
  return H.useContext(cn) ? T.jsx(T.Fragment, { children: e3 }) : T.jsx(ng, { initialNodes: t, initialEdges: n, defaultNodes: o, defaultEdges: r, initialWidth: i, initialHeight: s, fitView: c, initialFitViewOptions: u, initialMinZoom: a, initialMaxZoom: f, nodeOrigin: d, nodeExtent: l, children: e3 });
}
const rg = { width: "100%", height: "100%", overflow: "hidden", position: "relative", zIndex: 0 };
function ig({ nodes: e3, edges: t, defaultNodes: n, defaultEdges: o, className: r, nodeTypes: i, edgeTypes: s, onNodeClick: c, onEdgeClick: u, onInit: a, onMove: f, onMoveStart: d, onMoveEnd: l, onConnect: h, onConnectStart: x, onConnectEnd: p, onClickConnectStart: _, onClickConnectEnd: y, onNodeMouseEnter: M, onNodeMouseMove: g, onNodeMouseLeave: w, onNodeContextMenu: C, onNodeDoubleClick: b, onNodeDragStart: S, onNodeDrag: R, onNodeDragStop: $, onNodesDelete: X, onEdgesDelete: D, onDelete: z, onSelectionChange: B, onSelectionDragStart: v, onSelectionDrag: A, onSelectionDragStop: N, onSelectionContextMenu: I, onSelectionStart: k, onSelectionEnd: P, onBeforeDelete: V, connectionMode: m, connectionLineType: E = Ae.Bezier, connectionLineStyle: L, connectionLineComponent: O, connectionLineContainerStyle: Y, deleteKeyCode: q = "Backspace", selectionKeyCode: F = "Shift", selectionOnDrag: j = false, selectionMode: Z = dt.Full, panActivationKeyCode: Q = "Space", multiSelectionKeyCode: J = gt() ? "Meta" : "Control", zoomActivationKeyCode: U = gt() ? "Meta" : "Control", snapToGrid: K, snapGrid: te, onlyRenderVisibleElements: oe = false, selectNodesOnDrag: re, nodesDraggable: ae, autoPanOnNodeFocus: _e, nodesConnectable: ke, nodesFocusable: bt, nodeOrigin: St = Vi, edgesFocusable: Ke, edgesReconnectable: Qe, elementsSelectable: dn = true, defaultViewport: Nt = Td, minZoom: Le = 0.5, maxZoom: Je = 2, translateExtent: uo = ft, preventScrolling: ps = true, nodeExtent: hn, defaultMarkerColor: ms = "#b1b1b7", zoomOnScroll: ys = true, zoomOnPinch: xs = true, panOnScroll: ws = false, panOnScrollSpeed: vs = 0.5, panOnScrollMode: _s = $e.Free, zoomOnDoubleClick: Es = true, panOnDrag: bs = true, onPaneClick: Ss, onPaneMouseEnter: Ns, onPaneMouseMove: Cs, onPaneMouseLeave: Ms, onPaneScroll: As, onPaneContextMenu: Is, paneClickDistance: ks = 0, nodeClickDistance: Ts = 0, children: Ps, onReconnect: Rs, onReconnectStart: $s, onReconnectEnd: Ds, onEdgeContextMenu: Hs, onEdgeDoubleClick: zs, onEdgeMouseEnter: Os, onEdgeMouseMove: Ls, onEdgeMouseLeave: Vs, reconnectRadius: Bs = 10, onNodesChange: js, onEdgesChange: Fs, noDragClassName: Ys = "nodrag", noWheelClassName: Xs = "nowheel", noPanClassName: lo = "nopan", fitView: fo, fitViewOptions: ho, connectOnClick: Zs, attributionPosition: qs, proOptions: Ws, defaultEdgeOptions: Us, elevateNodesOnSelect: Gs, elevateEdgesOnSelect: Ks, disableKeyboardA11y: go = false, autoPanOnConnect: Qs, autoPanOnNodeDrag: Js, autoPanSpeed: ea, connectionRadius: ta, isValidConnection: na, onError: oa, style: ra, id: po, nodeDragThreshold: ia, connectionDragThreshold: sa, viewport: aa, onViewportChange: ca, width: ua, height: la, colorMode: fa = "light", debug: da, onScroll: mo, ariaLabelConfig: ha, ...ga }, pa) {
  const gn = po || "1", ma = Dd(fa), ya = H.useCallback((yo) => {
    yo.currentTarget.scrollTo({ top: 0, left: 0, behavior: "instant" }), mo == null ? void 0 : mo(yo);
  }, [mo]);
  return T.jsx("div", { "data-testid": "rf__wrapper", ...ga, onScroll: ya, style: { ...ra, ...rg }, ref: pa, className: se(["react-flow", r, ma]), id: po, role: "application", children: T.jsxs(og, { nodes: e3, edges: t, width: ua, height: la, fitView: fo, fitViewOptions: ho, minZoom: Le, maxZoom: Je, nodeOrigin: St, nodeExtent: hn, children: [T.jsx(eg, { onInit: a, onNodeClick: c, onEdgeClick: u, onNodeMouseEnter: M, onNodeMouseMove: g, onNodeMouseLeave: w, onNodeContextMenu: C, onNodeDoubleClick: b, nodeTypes: i, edgeTypes: s, connectionLineType: E, connectionLineStyle: L, connectionLineComponent: O, connectionLineContainerStyle: Y, selectionKeyCode: F, selectionOnDrag: j, selectionMode: Z, deleteKeyCode: q, multiSelectionKeyCode: J, panActivationKeyCode: Q, zoomActivationKeyCode: U, onlyRenderVisibleElements: oe, defaultViewport: Nt, translateExtent: uo, minZoom: Le, maxZoom: Je, preventScrolling: ps, zoomOnScroll: ys, zoomOnPinch: xs, zoomOnDoubleClick: Es, panOnScroll: ws, panOnScrollSpeed: vs, panOnScrollMode: _s, panOnDrag: bs, onPaneClick: Ss, onPaneMouseEnter: Ns, onPaneMouseMove: Cs, onPaneMouseLeave: Ms, onPaneScroll: As, onPaneContextMenu: Is, paneClickDistance: ks, nodeClickDistance: Ts, onSelectionContextMenu: I, onSelectionStart: k, onSelectionEnd: P, onReconnect: Rs, onReconnectStart: $s, onReconnectEnd: Ds, onEdgeContextMenu: Hs, onEdgeDoubleClick: zs, onEdgeMouseEnter: Os, onEdgeMouseMove: Ls, onEdgeMouseLeave: Vs, reconnectRadius: Bs, defaultMarkerColor: ms, noDragClassName: Ys, noWheelClassName: Xs, noPanClassName: lo, rfId: gn, disableKeyboardA11y: go, nodeExtent: hn, viewport: aa, onViewportChange: ca }), T.jsx($d, { nodes: e3, edges: t, defaultNodes: n, defaultEdges: o, onConnect: h, onConnectStart: x, onConnectEnd: p, onClickConnectStart: _, onClickConnectEnd: y, nodesDraggable: ae, autoPanOnNodeFocus: _e, nodesConnectable: ke, nodesFocusable: bt, edgesFocusable: Ke, edgesReconnectable: Qe, elementsSelectable: dn, elevateNodesOnSelect: Gs, elevateEdgesOnSelect: Ks, minZoom: Le, maxZoom: Je, nodeExtent: hn, onNodesChange: js, onEdgesChange: Fs, snapToGrid: K, snapGrid: te, connectionMode: m, translateExtent: uo, connectOnClick: Zs, defaultEdgeOptions: Us, fitView: fo, fitViewOptions: ho, onNodesDelete: X, onEdgesDelete: D, onDelete: z, onNodeDragStart: S, onNodeDrag: R, onNodeDragStop: $, onSelectionDrag: A, onSelectionDragStart: v, onSelectionDragStop: N, onMove: f, onMoveStart: d, onMoveEnd: l, noPanClassName: lo, nodeOrigin: St, rfId: gn, autoPanOnConnect: Qs, autoPanOnNodeDrag: Js, autoPanSpeed: ea, onError: oa, connectionRadius: ta, isValidConnection: na, selectNodesOnDrag: re, nodeDragThreshold: ia, connectionDragThreshold: sa, onBeforeDelete: V, debug: da, ariaLabelConfig: ha }), T.jsx(kd, { onSelectionChange: B }), Ps, T.jsx(Nd, { proOptions: Ws, position: qs }), T.jsx(Sd, { rfId: gn, disableKeyboardA11y: go })] }) });
}
var $g = ji(ig);
const sg = (e3) => {
  var _a2;
  return (_a2 = e3.domNode) == null ? void 0 : _a2.querySelector(".react-flow__edgelabel-renderer");
};
function Dg({ children: e3 }) {
  const t = ee(sg);
  return t ? Sa.createPortal(e3, t) : null;
}
function Hg() {
  const e3 = ne();
  return H.useCallback((t) => {
    const { domNode: n, updateNodeInternals: o } = e3.getState(), r = Array.isArray(t) ? t : [t], i = /* @__PURE__ */ new Map();
    r.forEach((s) => {
      const c = n == null ? void 0 : n.querySelector(`.react-flow__node[data-id="${s}"]`);
      c && i.set(s, { id: s, nodeElement: c, force: true });
    }), requestAnimationFrame(() => o(i, { triggerFitView: false }));
  }, []);
}
const ag = (e3) => (t) => {
...
function zg(e3 = { includeHiddenNodes: false }) {
  return ee(ag(e3));
}
function Og(e3) {
  return ee(H.useCallback((n) => n.nodeLookup.get(e3), [e3]), ie);
}
function cg({ dimensions: e3, lineWidth: t, variant: n, className: o }) {
  return T.jsx("path", { strokeWidth: t, d: `M${e3[0] / 2} 0 V${e3[1]} M0 ${e3[1] / 2} H${e3[0]}`, className: se(["react-flow__background-pattern", n, o]) });
}
function ug({ radius: e3, className: t }) {
...
const lg = { [Ie.Dots]: 1, [Ie.Lines]: 1, [Ie.Cross]: 6 }, fg = (e3) => ({ transform: e3.transform, patternId: `pattern-${e3.rfId}` });
function ds({ id: e3, variant: t = Ie.Dots, gap: n = 20, size: o, lineWidth: r = 1, offset: i = 0, color: s, bgColor: c, style: u, className: a, patternClassName: f }) {
  const d = H.useRef(null), { transform: l, patternId: h } = ee(fg, ie), x = o || lg[t], p = t === Ie.Dots, _ = t === Ie.Cross, y = Array.isArray(n) ? n : [n, n], M = [y[0] * l[2] || 1, y[1] * l[2] || 1], g = x * l[2], w = Array.isArray(i) ? i : [i, i], C = _ ? [g, g] : M, b = [w[0] * l[2] || 1 + C[0] / 2, w[1] * l[2] || 1 + C[1] / 2], S = `${h}${e3 || ""}`;
  return T.jsxs("svg", { className: se(["react-flow__background", a]), style: { ...u, ...ln, "--xy-background-color-props": c, "--xy-background-pattern-color-props": s }, ref: d, "data-testid": "rf__background", children: [T.jsx("pattern", { id: S, x: l[0] % M[0], y: l[1] % M[1], width: M[0], height: M[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${b[0]},-${b[1]})`, children: p ? T.jsx(ug, { radius: g / 2, className: f }) : T.jsx(cg, { dimensions: C, lineWidth: r, variant: t, className: f }) }), T.jsx("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${S})` })] });
}
ds.displayName = "Background";
const Lg = H.memo(ds);
function dg() {
...
const yg = (e3) => ({ isInteractive: e3.nodesDraggable || e3.nodesConnectable || e3.elementsSelectable, minZoomReached: e3.transform[2] <= e3.minZoom, maxZoomReached: e3.transform[2] >= e3.maxZoom, ariaLabelConfig: e3.ariaLabelConfig });
function hs({ style: e3, showZoom: t = true, showFitView: n = true, showInteractive: o = true, fitViewOptions: r, onZoomIn: i, onZoomOut: s, onFitView: c, onInteractiveChange: u, className: a, children: f, position: d = "bottom-left", orientation: l = "vertical", "aria-label": h }) {
  const x = ne(), { isInteractive: p, minZoomReached: _, maxZoomReached: y, ariaLabelConfig: M } = ee(yg, ie), { zoomIn: g, zoomOut: w, fitView: C } = ao(), b = () => {
    g(), i == null ? void 0 : i();
  }, S = () => {
    w(), s == null ? void 0 : s();
  }, R = () => {
  ...
  return T.jsxs(un, { className: se(["react-flow__controls", X, a]), position: d, style: e3, "data-testid": "rf__controls", "aria-label": h ?? M["controls.ariaLabel"], children: [t && T.jsxs(T.Fragment, { children: [T.jsx($t, { onClick: b, className: "react-flow__controls-zoomin", title: M["controls.zoomIn.ariaLabel"], "aria-label": M["controls.zoomIn.ariaLabel"], disabled: y, children: T.jsx(dg, {}) }), T.jsx($t, { onClick: S, className: "react-flow__controls-zoomout", title: M["controls.zoomOut.ariaLabel"], "aria-label": M["controls.zoomOut.ariaLabel"], disabled: _, children: T.jsx(hg, {}) })] }), n && T.jsx($t, { className: "react-flow__controls-fitview", onClick: R, title: M["controls.fitView.ariaLabel"], "aria-label": M["controls.fitView.ariaLabel"], children: T.jsx(gg, {}) }), o && T.jsx($t, { className: "react-flow__controls-interactive", onClick: $, title: M["controls.interactive.ariaLabel"], "aria-label": M["controls.interactive.ariaLabel"], children: p ? T.jsx(mg, {}) : T.jsx(pg, {}) }), f] });
}
hs.displayName = "Controls";
const Vg = H.memo(hs);
function xg({ id: e3, x: t, y: n, width: o, height: r, style: i, color: s, strokeColor: c, strokeWidth: u, className: a, borderRadius: f, shapeRendering: d, selected: l, onClick: h }) {
...
const wg = H.memo(xg), vg = (e3) => e3.nodes.map((t) => t.id), kn = (e3) => e3 instanceof Function ? e3 : () => e3;
function _g({ nodeStrokeColor: e3, nodeColor: t, nodeClassName: n = "", nodeBorderRadius: o = 5, nodeStrokeWidth: r, nodeComponent: i = wg, onClick: s }) {
  const c = ee(vg, ie), u = kn(t), a = kn(e3), f = kn(n), d = typeof window > "u" || window.chrome ? "crispEdges" : "geometricPrecision";
  return T.jsx(T.Fragment, { children: c.map((l) => T.jsx(bg, { id: l, nodeColorFunc: u, nodeStrokeColorFunc: a, nodeClassNameFunc: f, nodeBorderRadius: o, nodeStrokeWidth: r, NodeComponent: i, onClick: s, shapeRendering: d }, l)) });
}
function Eg({ id: e3, nodeColorFunc: t, nodeStrokeColorFunc: n, nodeClassNameFunc: o, nodeBorderRadius: r, nodeStrokeWidth: i, shapeRendering: s, NodeComponent: c, onClick: u }) {
...
const bg = H.memo(Eg);
var Sg = H.memo(_g);
const Ng = 200, Cg = 150, Mg = (e3) => !e3.hidden, Ag = (e3) => {
  ...
  return { viewBB: t, boundingRect: e3.nodeLookup.size > 0 ? mi(vt(e3.nodeLookup, { filter: Mg }), t) : t, rfId: e3.rfId, panZoom: e3.panZoom, translateExtent: e3.translateExtent, flowWidth: e3.width, flowHeight: e3.height, ariaLabelConfig: e3.ariaLabelConfig };
}, Ig = "react-flow__minimap-desc";
function gs({ style: e3, className: t, nodeStrokeColor: n, nodeColor: o, nodeClassName: r = "", nodeBorderRadius: i = 5, nodeStrokeWidth: s, nodeComponent: c, bgColor: u, maskColor: a, maskStrokeColor: f, maskStrokeWidth: d, position: l = "bottom-right", onClick: h, onNodeClick: x, pannable: p = false, zoomable: _ = false, ariaLabel: y, inversePan: M, zoomStep: g = 1, offsetScale: w = 5 }) {
  const C = ne(), b = H.useRef(null), { boundingRect: S, viewBB: R, rfId: $, panZoom: X, translateExtent: D, flowWidth: z, flowHeight: B, ariaLabelConfig: v } = ee(Ag, ie), A = (e3 == null ? void 0 : e3.width) ?? Ng, N = (e3 == null ? void 0 : e3.height) ?? Cg, I = S.width / A, k = S.height / N, P = Math.max(I, k), V = P * A, m = P * N, E = w * P, L = S.x - (V - S.width) / 2 - E, O = S.y - (m - S.height) / 2 - E, Y = V + E * 2, q = m + E * 2, F = `${Ig}-${$}`, j = H.useRef(0), Z = H.useRef();
  ...
  const Q = h ? (K) => {
    var _a2;
    const [te, oe] = ((_a2 = Z.current) == null ? void 0 : _a2.pointer(K)) || [0, 0];
    h(K, { x: te, y: oe });
  } : void 0, J = x ? H.useCallback((K, te) => {
    const oe = C.getState().nodeLookup.get(te).internals.userNode;
    x(K, oe);
  }, []) : void 0, U = y ?? v["minimap.ariaLabel"];
  return T.jsx(un, { position: l, style: { ...e3, "--xy-minimap-background-color-props": typeof u == "string" ? u : void 0, "--xy-minimap-mask-background-color-props": typeof a == "string" ? a : void 0, "--xy-minimap-mask-stroke-color-props": typeof f == "string" ? f : void 0, "--xy-minimap-mask-stroke-width-props": typeof d == "number" ? d * P : void 0, "--xy-minimap-node-background-color-props": typeof o == "string" ? o : void 0, "--xy-minimap-node-stroke-color-props": typeof n == "string" ? n : void 0, "--xy-minimap-node-stroke-width-props": typeof s == "number" ? s : void 0 }, className: se(["react-flow__minimap", t]), "data-testid": "rf__minimap", children: T.jsxs("svg", { width: A, height: N, viewBox: `${L} ${O} ${Y} ${q}`, className: "react-flow__minimap-svg", role: "img", "aria-labelledby": F, ref: b, onClick: Q, children: [U && T.jsx("title", { id: F, children: U }), T.jsx(Sg, { onClick: J, nodeColor: o, nodeStrokeColor: n, nodeBorderRadius: i, nodeClassName: r, nodeStrokeWidth: s, nodeComponent: c }), T.jsx("path", { className: "react-flow__minimap-mask", d: `M${L - E},${O - E}h${Y + E * 2}v${q + E * 2}h${-Y - E * 2}z
        M${R.x},${R.y}h${R.width}v${R.height}h${-R.width}z`, fillRule: "evenodd", pointerEvents: "none" })] }) });
}
gs.displayName = "MiniMap";
H.memo(gs);
const kg = (e3) => (t) => e3 ? `${Math.max(1 / t.transform[2], 1)}` : void 0, Tg = { [Oe.Line]: "right", [Oe.Handle]: "bottom-right" };
function Pg({ nodeId: e3, position: t, variant: n = Oe.Handle, className: o, style: r = void 0, children: i, color: s, minWidth: c = 10, minHeight: u = 10, maxWidth: a = Number.MAX_VALUE, maxHeight: f = Number.MAX_VALUE, keepAspectRatio: d = false, resizeDirection: l, autoScale: h = true, shouldResize: x, onResizeStart: p, onResize: _, onResizeEnd: y }) {
  const M = Zi(), g = typeof e3 == "string" ? e3 : M, w = ne(), C = H.useRef(null), b = n === Oe.Handle, S = ee(H.useCallback(kg(b && h), [b, h]), ie), R = H.useRef(null), $ = t ?? Tg[n];
  H.useEffect(() => {
...
const kr = H.memo(Pg);
function Bg({ nodeId: e3, isVisible: t = true, handleClassName: n, handleStyle: o, lineClassName: r, lineStyle: i, color: s, minWidth: c = 10, minHeight: u = 10, maxWidth: a = Number.MAX_VALUE, maxHeight: f = Number.MAX_VALUE, keepAspectRatio: d = false, autoScale: l = true, shouldResize: h, onResizeStart: x, onResize: p, onResizeEnd: _ }) {
  return t ? T.jsxs(T.Fragment, { children: [Jf.map((y) => T.jsx(kr, { className: r, style: i, nodeId: e3, position: y, variant: Oe.Line, color: s, minWidth: c, minHeight: u, maxWidth: a, maxHeight: f, onResizeStart: x, keepAspectRatio: d, autoScale: l, shouldResize: h, onResize: p, onResizeEnd: _ }, y)), Qf.map((y) => T.jsx(kr, { className: n, style: o, nodeId: e3, position: y, color: s, minWidth: c, minHeight: u, maxWidth: a, maxHeight: f, onResizeStart: x, keepAspectRatio: d, autoScale: l, shouldResize: h, onResize: p, onResizeEnd: _ }, y))] }) : null;
}
export {
  fn as B,
  $t as C,
